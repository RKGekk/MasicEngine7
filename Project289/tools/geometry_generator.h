...
private:
	...
	void Subdivide(Vertices& input_copy_vertices, Indices& input_copy_indices);
	...
	void BuildCylinderTopCap(float bottomRadius, float topRadius, float height, unsigned int sliceCount, unsigned int stackCount, Vertices& vertices, Indices& indices);
	void BuildCylinderBottomCap(float bottomRadius, float topRadius, float height, unsigned int sliceCount, unsigned int stackCount, Vertices& vertices, Indices& indices);
};